...
unless ui_test_target
  ...
  group.new_file('AppUITests/Info.plist')
  swift_file1 = group.new_file('AppUITests/AppUITests.swift')
  swift_file2 = group.new_file('AppUITests/AppLaunchTests.swift')
  
  ui_test_target.add_file_references([swift_file1, swift_file2])
